                      ...
                      children: [
                        ListTile(
                          ...
                          trailing: GestureDetector(
                            onTap: () {
                              setState(() {
                                isExpanded = !isExpanded; // expand বা collapse করার লজিক
                              });
                            },
                            child: Icon(
                              isExpanded
                                  ? Icons.arrow_drop_up // expand হলে আপ আইকন দেখাবে
                                  : Icons.arrow_forward_ios, // collapse হলে ফরওয়ার্ড আইকন দেখাবে
                              color: Colors.teal,
                            ),
                          ),
                        ),
