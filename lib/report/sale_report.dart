...
class CustomerLendingReport extends StatefulWidget {
  @override
  _CustomerLendingReportState createState() => _CustomerLendingReportState();
}

class _CustomerLendingReportState extends State<CustomerLendingReport> {
  // Sample transactions
